<div class="container">
    <div class="row align-items-center justify-content-xxl-between  justify-content-around">
            ...
            <div>
                <div class="swiper-button-next position-static d-inline-block">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <img src="/assets/images/send-arrow.png" alt="arrow">
                        <div class="d-flex align-items-center gap-2">
        ...
        <div class="col-xxl-5 col-md-4 col-4 pt-3">
            <img src="/assets/images/ourportfolio.png" class="portfolio-circle d-md-block d-none" alt="our-portfolio">

                    ...
                    <div class="swiper-slide align-items-center d-flex">
                        <div class="row justify-content-lg-between justify-content-center">
                            <div class="col-xxl-6 col-lg-5 col-10 d-flex text-lg-start text-center flex-column justify-content-evenly">
                                ...
                                <p class="mb-xl-5 mb-2">At Fawcett Publication s, our extensive history in book
                                    publishing
                                    sets
                                    us apart. We
                    ...
                    <div class="swiper-slide d-flex align-items-center">
                        <div class="row justify-content-lg-between justify-content-center">
                            <div class="col-xxl-6 col-lg-5 col-10 d-flex text-lg-start text-center flex-column justify-content-evenly">
                                ...
                                <p class="mb-xl-5 mb-2">Our vast network within the publishing industry opens doors for
                                    our

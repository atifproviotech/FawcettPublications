            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-muted mb-4">
                        ...
                        fades and wears quickly, trade paperbacks are built to last—printed on durable, high-grade paper that
                        preserves your story’s value over time.
                    </p>
                    <p class="text-muted mb-4">
                        Our trade paperbacks are designed to balance affordability with elegance, giving readers a
                        professional-quality book that also feels accessible.
                    </p>
                    <h5 class="fw-semibold mt-4">We offer softcover publishing in a variety of trim sizes to suit your book’s style:</h5>

                    <div class="row mt-4">
                        <div class="col-md-12 mb-3">
                            <div class="p-3 bg-white rounded-3 shadow-sm h-100">
                                <h6 class="text-primary">Black & White Softcover Sizes</h6>
                                <ul class="list-unstyled mt-2">
                                    <li>5" x 8"</li>
                                    <li>6" x 9"</li>
                                    <li>8.25" x 11"</li>
                                </ul>
                                <p class="small text-muted mb-0">Minimum page count: 48 | Maximum page count: 900</p>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="p-3 bg-white rounded-3 shadow-sm h-100">
                                <h6 class="text-success">Color Softcover Sizes</h6>
                                <ul class="list-unstyled mt-2">
                                    <li>8.5" x 8.5"</li>
                                    <li>8.5" x 11"</li>
                                </ul>
                                <p class="small text-muted mb-0">Minimum page count: 24 | Maximum page count: 480</p>
                            </div>
                        </div>
                    </div>

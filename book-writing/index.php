    ...
    <section class="hero-page">
        <div class="container">
            <div class="row align-items-center justify-content-lg-between justify-content-center">
                <div class="col-lg-6 col-md-10 col-12 text-lg-start text-center">
                    ...
                    <ul class="d-flex align-items-center justify-content-lg-start justify-content-center ser-hero-img mb-lg-5">
